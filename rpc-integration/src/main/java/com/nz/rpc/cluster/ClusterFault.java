 ...
 * @date 5/8/19
*/
public interface ClusterFault {

    default public  Object handle(ClientInvocation invocation,Exception ex) throws Exception{
        return doHandle(invocation,ex) ;
    }

    Object doHandle(ClientInvocation invocation,Exception ex)throws Exception;
}
